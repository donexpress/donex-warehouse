...
const StoragePlanIndex = ({ storagePlanStates, storagePCount }: StoragePlanListProps) => {console.log(storagePlanStates)
  return (
    <Layout>
      <Head>
      ...
      <ProtectedRoute>
        <TableStoragePlan storagePlanStates={storagePlanStates ? storagePlanStates : []} storagePCount={storagePCount} />
      </ProtectedRoute>
    </Layout>
  );
};
