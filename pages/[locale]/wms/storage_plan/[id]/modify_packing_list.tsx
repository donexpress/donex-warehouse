...
const ModifyPackingList = ({ id, storagePlan }: PackingListProps) => {console.log(storagePlan)
  ...
  <ProtectedRoute>
      <Layout>
        ...
        <PackingListForm storagePlan={storagePlan} id={id} isFromModifyPackingList={true} />
      </Layout>
    </ProtectedRoute>
    );
};
