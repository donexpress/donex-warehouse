...
const ShowStoragePlan = ({ warehouses, users, id, storagePlan }: StoragePlanProps) => {
  ...
  <ProtectedRoute>
      <Layout>
        ...
        <StoragePlanFormBody warehouses={warehouses ? warehouses : []} users={users ? users : []} storagePlan={storagePlan} id={id} isFromDetails={true} />
      </Layout>
    </ProtectedRoute>
    );
};
