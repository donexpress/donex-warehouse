...
const ShowWarehouseCargoStation = ({ states, countries, receptionAreas, warehouse, id }: CargoStationWarehouseProps) => {
    ...
    <ProtectedRoute>
        <Layout>
          ...
          <CargoStationWarehouseFormBody states={states ? states : []} countries={countries ? countries : []} receptionAreas={receptionAreas} warehouse={warehouse} id={id} isFromDetails={true} />
        </Layout>
      </ProtectedRoute>
      );
  };
