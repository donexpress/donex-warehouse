...
const UpdateExitPlan = ({ exitPlan, id, countries, users, warehouses }: ExitPlanProps) => {
  return (
    <Layout>
      <Head>
      ...
      <ProtectedRoute>
        <ExitPlanFormBody exitPlan={exitPlan} id={id} isFromDetails={false} countries={countries} users={users} warehouses={warehouses} />
      </ProtectedRoute>
    </Layout>
  );
};
