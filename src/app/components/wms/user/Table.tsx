...
const INITIAL_VISIBLE_COLUMNS = ["customer_number", "username", "contact", 'payment_method', "actions"];
...
const UserTable = ({ userList }: UsersProps) => {
    ...
    const columns = [
        ...
        {name: intl.formatMessage({ id: 'customer_number' }), uid: "customer_number", sortable: true},
        {name: intl.formatMessage({ id: 'username' }), uid: "username", sortable: true},
        {name: intl.formatMessage({ id: 'contact' }), uid: "contact", sortable: true},
        {name: intl.formatMessage({ id: 'payment_method' }), uid: "payment_method_id", sortable: true},
    ...
    const filteredItems = React.useMemo(() => {
        ...
        filteredUsers = filteredUsers.filter((user) =>
            ...
            || (user.customer_number?.toString())?.toLowerCase()?.includes(filterValue.toLowerCase())
            || user.contact?.toLowerCase()?.includes(filterValue.toLowerCase())
            || (user.payment_method_id?.toString())?.toLowerCase()?.includes(filterValue.toLowerCase()),
        );
        }
