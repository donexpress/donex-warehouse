            ...
            <div className='flex flex-col gap-3'>
              ...
              <div className="elements-row-end w-full">
                <Button
                  ...
                  disabled={((carrierValue.trim() === "" || trackingNumberValue.trim() === "" || clientReferenceValue.trim() === "") && where === undefined) || where === "supplier" && (currentChangeValue === "" || !validateBillCode(billCodeValue)) || data === undefined}
                >
